    ...
    run_mongo_etl = EmrServerlessStartJobOperator(
        ...
        job_driver={
            "sparkSubmit": {
                ...
                "sparkSubmitParameters": f"--py-files s3://{S3_BUCKET}/scripts/schema_validator.py,s3://{S3_BUCKET}/scripts/data_quality.py,s3://{S3_BUCKET}/scripts/encryption_utils.py --jars s3://{S3_BUCKET}/jars/mongo-spark-connector_2.12-10.3.0.jar,s3://{S3_BUCKET}/jars/mongodb-driver-sync-4.8.2.jar,s3://{S3_BUCKET}/jars/mongodb-driver-core-4.8.2.jar,s3://{S3_BUCKET}/jars/bson-4.8.2.jar,s3://{S3_BUCKET}/jars/mongodb-crypt-1.5.2.jar --conf spark.executor.cores=4 --conf spark.executor.memory=14g --conf spark.driver.cores=4 --conf spark.driver.memory=14g --conf spark.dynamicAllocation.enabled=false --conf spark.sql.shuffle.partitions=8 --conf spark.sql.adaptive.enabled=true --conf spark.hadoop.fs.s3.enableServerSideEncryption=true --conf spark.hadoop.fs.s3.serverSideEncryption.kms.keyId={KMS_KEY_ARN}"
            }
        },
